# MatrixClass
#### Udacity project on implementing a Matrix Class using the Kalman filter. Please note this is a working solution. To see where the Matrix Class has been implemented please see matrix.py and refer to sections noted as TO DO.
